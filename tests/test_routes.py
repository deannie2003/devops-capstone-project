...
class TestAccountService(TestCase):
    ...
    def test_update_account(self):
        ...
        account = self._create_accounts(1)[0]
        update_data = {"name": "Updated Name", "email": "updated.email@example.com"}
    ...
    def test_update_account(self):
        ...
        self.assertEqual(data["date_joined"], "2024-09-04")

    def test_update_account_not_found(self):
        """It should not Update an Account that is not found"""
        update_data = {"name": "Updated Name", "email": "updated.email@example.com"}
        resp = self.client.put(
            f"{BASE_URL}/0", json=update_data, content_type="application/json"
        )
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_delete_account_not_found(self):
        """It should do nothing if the Account is not found"""

...
from service.exceptions import DataValidationError  # Thêm dòng import này
...
def update_account(account_id):
    """
    Updates an Account based on the account_id
    """
    app.logger.info("Request to update an Account with id: %s", account_id)
    data = request.get_json()
    app.logger.info("Update data: %s", data)
    ...
    try:
        ...
        app.logger.error(f"DataValidationError: {e}")
